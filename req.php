        ...
        <script>
            ...
            function actionFormatter(value, row, index) {
                ...
                return [
                    ...
                    '</a>',
                    '<a class="remove ml10" href="javascript:void(0)" title="Hist�rico">',
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active">
                            <a href="index.php">
                                <i class="fa fa-home"></i> <span>In�cio</span>
                            </a>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="alunoEngComp.php"><i class="fa fa-angle-double-right"></i> Engenharia Computa��o</a></li>
                        ...
                        <li>
                            <a href="relatorio.php">
                                <i class="fa fa-bar-chart-o"></i> <span>Relat�rios</span> <small class="badge pull-right bg-green">label2</small>
                            </a>
                        </li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> In�cio</a></li>
